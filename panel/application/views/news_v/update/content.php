                ...
                <form action="<?php echo base_url("news/update/$item->id"); ?>" method="post" enctype="multipart/form-data" >
                    ...
                    <?php if(isset($form_error)){  ?>
                        ...
                        <div class="form-group video_url_container" style="display: <?php echo ($news_type == "video")?"block" : "none"; ?>;">
                            ...
                            <input class="form-control" placeholder="Video bağlantısını giriniz" name="video_url">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group video_url_container" style="display: <?php echo ($item->news_type == "video")?"block" : "none"; ?>;">
                            <label>Video URL</label>
                            <input class="form-control" placeholder="Video bağlantısını giriniz" name="video_url" value="<?php echo $item->video_url; ?>">
                        </div>
                    ...
                    <a href="<?php echo base_url("news"); ?>" class="btn btn-danger btn-outline">İptal</a>
                </form>
            </div><!-- .widget-body -->
        </div><!-- .widget -->
    </div>
